...
getNewQuestion = () => {
    if (questionCounter >= questions.length) {
        ...
        // go to end page
        return window.location.assign("../and-thus-we-finish.html");
    }
...
// let url = `https://docs.google.com/spreadsheets/d/1gI9p2ZQQdmxbcOr-VFgLu-5r8ZrycA9mNJwve5pIvQ4/gviz/tq?`;
// let sheetId = url.substring(39).slice(0,-9); 
// let range = `A2`
// let postToSheet = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${range}:append?key=AIzaSyALLJccfZhHNvoTsMn6wFZ9qchzHCf8hh8`
// console.log(sheetId)
// // fetch(url)
// // .then(res => res.text())
// // .then(rep => { 
